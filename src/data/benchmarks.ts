...
const BENCHMARK_LINK_OVERRIDES: Record<string, string> = {
  ...
  "bigbench-extra-hard": "https://github.com/google/BIG-bench",
  "claw-eval": "https://github.com/google-research/google-research/tree/master/claw",
  "covost": "https://github.com/facebookresearch/covost",
  "fleurs": "https://google.github.io/fleurs/",
  "frontiermath": "https://github.com/evalai/FrontierMath",
  "frontiermath-tier-4": "https://github.com/evalai/FrontierMath",
  "expert-swe": "https://github.com/openai/openai-evaluations",
  "mle-bench-lite": "https://github.com/openai/mle-bench",
  "mm-clawbench": "https://github.com/google-research/google-research/tree/master/claw",
  "androidworld": "https://github.com/google-research/android_world",
  "mlvu": "https://github.com/JUNJIE99/MLVU",
  "mvbench": "https://github.com/JUNJIE99/MVBench",
  "medxpertqa-mm": "https://github.com/google-deepmind/medxpertqa",
  "genebench": "https://github.com/google-deepmind/genebench",
  "bixbench": "https://github.com/google-deepmind/bixbench",
  "hmmt-nov-2025": "https://www.hmmt.co.uk/",
  "finance-agent": "https://github.com/anthropic/finance-agent-bench",
  "officeqa-pro": "https://github.com/anthropic/officeqa-pro",
  "structural-biology": "https://www.rcsb.org/",
  "swe-multimodal": "https://www.swebench.com/",
};
...
const rawBenchmarks: Benchmark[] = [
  ...
  },
  {
    ...
    name: "OJBench (Python)",
    category: "Coding",
    description: "Online judge programming benchmark for Python.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  ...
  },
  {
    ...
    name: "HMMT Nov 2025",
    category: "Math",
    description: "Harvard-MIT Mathematics Tournament November 2025 - High difficulty competition math.",
    maxScore: 100,
    higherIsBetter: true,
  },
  {
    ...
    name: "HMMT Feb 2026",
    category: "Math",
    description: "Harvard-MIT Mathematics Tournament 2026 - High difficulty competition math.",
    maxScore: 100,
    higherIsBetter: true,
  },
  {
  ...
  },
  {
    ...
    name: "Claw-Eval",
    category: "Agentic",
    description: "Benchmark for daily agentic tasks across text and multimodal interactions.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "APEX-Agents",
    category: "Agentic",
    description: "Advanced agentic planning and execution benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  ...
  },
  {
    ...
    name: "MedXPertQA MM",
    category: "Vision",
    description: "Multimodal medical question answering benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "CoVoST",
    category: "Multimodal",
    description: "Multilingual speech-to-text translation benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "FLEURS",
    category: "Multimodal",
    description: "Few-shot learning evaluation of universal representations of speech. Error rate (lower is better).",
    maxScore: 1,
    minScore: 0,
    higherIsBetter: false,
    normalization: "inverse",
  ...
  },
  {
    ...
    name: "FrontierMath",
    category: "Math",
    description: "Advanced mathematics benchmark with tiered difficulty.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "Expert-SWE",
    category: "Coding",
    description: "Long-horizon software engineering tasks requiring expert-level reasoning.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "MLE-Bench Lite",
    category: "Coding",
    description: "Lite version of machine learning engineering benchmark measuring medal rate.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "MM-ClawBench",
    category: "Agentic",
    description: "Multimodal agent benchmark for daily tasks.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "AndroidWorld",
    category: "Agentic",
    description: "Mobile device control and task completion benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  ...
  },
  {
    ...
    name: "MVBench",
    category: "Video",
    description: "Comprehensive video understanding benchmark across multiple tasks.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "GeneBench",
    category: "STEM",
    description: "Genetics and quantitative biology benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "BixBench",
    category: "STEM",
    description: "Bioinformatics and data analysis benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "Finance Agent",
    category: "Agentic",
    description: "Financial analysis and reasoning benchmark for agentic workflows.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    name: "OfficeQA Pro",
    category: "Agentic",
    description: "Advanced document reasoning and office task completion benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    category: "STEM",
    description: "Protein structure and molecular biology reasoning benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    category: "Coding",
    description: "Software engineering benchmark with multimodal inputs.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
  },
  {
    ...
    category: "Math",
    description: "Hardest tier of FrontierMath advanced mathematics benchmark.",
    maxScore: 100,
    higherIsBetter: true,
    normalization: "max",
    unit: "%",
