        ...
        <div className="container mx-auto flex h-14 items-center justify-between gap-3 px-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden sm:flex items-center gap-2 rounded-full border border-border/60 bg-muted/20 px-3 py-1.5 text-xs text-muted-foreground hover:bg-muted/40 hover:text-foreground transition-colors"
            >
              <Search className="h-3.5 w-3.5" />
              <span>Search…</span>
              <kbd className="pointer-events-none ml-2 rounded border border-border/60 bg-muted px-1.5 py-0.5 font-mono text-[10px]">⌘K</kbd>
            </button>
